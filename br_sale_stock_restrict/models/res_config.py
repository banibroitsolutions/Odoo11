...
class ResConfigInherit(models.TransientModel):
    ...
    def get_values(self):
        ...
        product_restriction = params('br_sale_stock_restrict.product_restriction')
        check_stock = params('br_sale_stock_restrict.check_stock')
        res.update(
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param(
            'br_sale_stock_restrict.product_restriction', self.product_restriction)
        self.env['ir.config_parameter'].sudo().set_param(
            'br_sale_stock_restrict.check_stock', self.check_stock)
