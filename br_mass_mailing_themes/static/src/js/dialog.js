odoo.define('br_mass_mailing_themes.dialogs', function (require) {
'use strict';
...
var MassMailingDialog = Dialog.extend({
    ...
    template: 'br_mass_mailing_themes.dialog',
    xmlDependencies: Dialog.prototype.xmlDependencies.concat(
        ['/br_mass_mailing_themes/static/src/xml/dialog.xml']
    ),
    /**
     * @constructor
     */
    ...
    */
    willStart: function () {
        ...
        defs.push(this._rpc({
            route: '/br_mass_mailing_themes/get_module_state',
            params: {
...
var ProductSelectorDialog = MassMailingDialog.extend({
    template: 'br_mass_mailing_themes.dialog_products',
    routePath: '/br_mass_mailing_themes/get_product_by_name',
    routeForItemDetail: '/br_mass_mailing_themes/get_products_info',
...
var BlogSelectorDialog = MassMailingDialog.extend({
    routePath: '/br_mass_mailing_themes/get_blog_by_name',
    routeForItemDetail: '/br_mass_mailing_themes/get_blogs_info',
...
var EventSelectorDialog = MassMailingDialog.extend({
    routePath: '/br_mass_mailing_themes/get_event_by_name',
    routeForItemDetail: '/br_mass_mailing_themes/get_events_info',
