odoo.define('br_mass_mailing_themes.snippet.options', function (require) {
'use strict';

var options = require('web_editor.snippets.options');
var core = require('web.core');
var qweb = core.qweb;
var MassMailingDialogs = require('br_mass_mailing_themes.dialogs');
...
options.registry.d_mass_mailing_theme_option_daddy = options.Class.extend({
    xmlDependencies: ['/br_mass_mailing_themes/static/src/xml/snippets_template.xml'],
    ...
    */
    _fetchAndAppend: function (data) {
        ...
        this._rpc({
            ...
            self.$target.empty().append(qweb.render('br_mass_mailing_themes.' + data.snippetTemplate, result));
        });
    },
});
