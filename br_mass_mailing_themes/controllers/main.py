...
class DroggolMassMailingThemes(http.Controller):
    ...
    @http.route('/br_mass_mailing_themes/get_module_state', type='json', auth='user')
    ...
    @http.route('/br_mass_mailing_themes/get_event_by_name', type='http', website=True)
    ...
    @http.route('/br_mass_mailing_themes/get_events_info', type='json', auth='public', website=True)
    ...
    @http.route('/br_mass_mailing_themes/get_blog_by_name', type='http', website=True)
    def get_blog_by_name(self, term='', **post):
        domain = [('website_published', '=', True), ('name', 'ilike', (term or ''))]
        result = self._get_blogs(domain)
        return json.dumps(result)

    @http.route('/br_mass_mailing_themes/get_blogs_info', type='json', auth='public', website=True)
    ...
    @http.route('/br_mass_mailing_themes/get_product_by_name', type='http', website=True)
    ...
    @http.route('/br_mass_mailing_themes/get_products_info', type='json', auth='public', website=True)
